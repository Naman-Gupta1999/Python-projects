...
def attend():
    os.startfile(os.getcwd() +"D:\PycharmProjects\Coder\x0cirebase\x07ttendance_files\x07ttendance2019-07-09.xls'" + str(datetime.now().date()) + '.xls')
...
Button(root, text="Report", font=('times new roman', 20), bg="#0D47A1", fg="white", command=function5).grid(row=8,
                                                                                                                columnspan=2,
                                                                                                                sticky=N + E + W + S,
                                                                                                                padx=5,
                                                                                                                pady=5)
